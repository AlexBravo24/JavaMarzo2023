...
public class Laptop {
	...
	//pero que aun son alcanzables de modificar
	//mediante sus getter y setters
	
	//private static double precio = 5000.55;
	
	//con el modificador final creamos constantes con valores
	//inmutables. puedo retornar su valor, pero no cambiarlo
	
	//private static final double precio = 5000.55;
	
	/*
	 * Hablar de la capacidad, memoria, procesador
	 * Un disco duro,una memoria ram y un procesador
	 * tambien son objetos
	 * En este ejemplo, la composicion se basa en que 
