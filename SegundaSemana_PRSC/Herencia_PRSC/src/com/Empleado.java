...
//La herencia nos permite reutilizar código de otra clase
//(De una clase padre)
// La HARENCIA se realiza con la palabra reservada "extends"
//después del nombre de la clase que va a heredar dichos atributos
public class Empleado extends Persona {

	//Un empleado también es una persona pero tiene
	//otros atributos que lo vuelven específicamente
	//un empleado
	...
	//Oara generar un constructor con los parámetros heredados 
	//de la clase padre, primero realizamos herencia con la palabra extends
	//Y al generar el constructor elegimos la opción de el constructor 
	//de la clase padre
	...
	//y comportamientos (métodos) e implementarlos si
	//es necesario o si los métodos son asbtractos
