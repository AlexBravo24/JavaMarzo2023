...
public class Ejercicio9_AOF {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
	//Ejercicio9:Realiza un programa que pida el día de la semana (del 1 al 7) y escriba el día correspondiente. Si 
	...
	// Solicitud de datos 
	    ...
	    dia = scanner.nextInt();
	// Realizamos comparaciones y mostramos 
	    switch (dia) {
	    case 1:
