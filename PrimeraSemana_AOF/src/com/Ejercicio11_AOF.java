...
public class Ejercicio11_AOF {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
//Ejercicio11: Una compañía de transporte internacional tiene servicio en algunos países de América del Norte, América 
...
//		la zona a la que va dirigida. Lo anterior se muestra en la siguiente tabla
		 ...
		 // Solicitud de datos al usuario
		    ...
		    if (peso > 5){
		      System.out.println("El paquete no puede ser admitido por seguridad.");
		    } else if (peso < 1) {
