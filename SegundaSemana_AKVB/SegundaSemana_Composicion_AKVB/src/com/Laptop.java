...
public class Laptop {
	 ...
	 * pero que aún son alcanzables a modificar mediante sus getters
	 * y setters.
	 * 
	 * Con el modificador final creamos constantes con valores inmutables.
	 * Se puede retornar su valor, pero no cambiarlo.
	 */
	
	/*
	 * Hablando de la capacidad, memoria, procesador
	 * Un disco duro, memoria ram, procesador, también
	 * son objetos.
	 * En este ejemplo, la composición se basa en que podemos
	 * tener objetos que formen parte de un objeto mas grande.
	 */
...
*/
	...
	public String toString() {
		return "Laptop [marca = " + marca + ", sistema = " + sistema 
				+ ", precio = " + precio + ", color = " + color + ", ram = "
